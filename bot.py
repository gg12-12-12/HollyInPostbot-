...
TEXTS = {
    "ua": {
        "welcome": (
            ...
            "👤 Свої замовлення та збережені дані завжди можна "
            "переглянути командою /profile\n\n"
    ...
    "pl": {
        "welcome": (
            ...
            "👤 Swoje zamówienia i zapisane dane zawsze sprawdzisz "
            "komendą /profile\n\n"
    ...
    "en": {
        "welcome": (
            ...
            "👤 You can always check your orders and saved details "
            "with /profile\n\n"
