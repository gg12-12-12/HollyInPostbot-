...
TEXTS = {
    "ua": {
        "welcome": (
            ...
            "👇 <b>Меню внизу екрана:</b>\n"
            "🛒 <b>Відкрити магазин</b> — каталог і кошик\n"
            "👤 <b>Профіль</b> — твоя статистика й збережені дані\n"
            "🧾 <b>Мої замовлення</b> — історія та статуси\n"
            "❓ <b>Як замовити</b> — ця інструкція\n"
            "💬 <b>Менеджер</b> — звʼязок з нами\n\n"
        ...
        "menu_profile_btn": "👤 Профіль",
        "menu_orders_btn": "🧾 Мої замовлення",
        "menu_help_btn": "❓ Як замовити",
        "menu_manager_btn": "💬 Менеджер",
        "manager_contact": (
            "💬 <b>Звʼязок з менеджером</b>\n\n"
            "З будь-яких питань пиши: @hollymollydeal\n\n"
            "🕐 Працюємо: Пн-Пт 6:00-23:00 · Сб-Нд 10:00-22:00"
        ),
        ...
        "profile_title": "👤 <b>Профіль: {name}</b>",
        "profile_stats": "🛒 Замовлень: <b>{count}</b> · на суму <b>{total} zł</b>",
        "profile_since": "📅 З нами від {date}",
        "profile_delivery_title": "<b>Збережені дані доставки:</b>",
        "profile_orders_title": "<b>Останні замовлення:</b>",
        "profile_no_orders": "Замовлень поки немає — саме час обрати щось смачне 🛒",
        "profile_empty": "Профіль ще порожній. Зроби перше замовлення, і тут з'явиться історія 🛒",
        ...
        "promo_applied_note": "🎟 Промокод <b>{code}</b> застосовано — знижка {percent}% уже врахована в сумі.",
        "payment_confirmed": (
    ...
    "pl": {
        "welcome": (
            ...
            "👇 <b>Menu na dole ekranu:</b>\n"
            "🛒 <b>Otwórz sklep</b> — katalog i koszyk\n"
            "👤 <b>Profil</b> — twoje statystyki i zapisane dane\n"
            "🧾 <b>Moje zamówienia</b> — historia i statusy\n"
            "❓ <b>Jak zamówić</b> — ta instrukcja\n"
            "💬 <b>Menedżer</b> — kontakt z nami\n\n"
        ...
        "menu_orders_btn": "🧾 Moje zamówienia",
        "menu_help_btn": "❓ Jak zamówić",
        "menu_manager_btn": "💬 Menedżer",
        "manager_contact": (
            "💬 <b>Kontakt z menedżerem</b>\n\n"
            "W razie pytań pisz: @hollymollydeal\n\n"
            "🕐 Godziny: Pn-Pt 6:00-23:00 · Sb-Nd 10:00-22:00"
        ),
        ...
        "profile_title": "👤 <b>Profil: {name}</b>",
        "profile_stats": "🛒 Zamówień: <b>{count}</b> · na kwotę <b>{total} zł</b>",
        "profile_since": "📅 Z nami od {date}",
        "profile_delivery_title": "<b>Zapisane dane dostawy:</b>",
        "profile_orders_title": "<b>Ostatnie zamówienia:</b>",
        "profile_no_orders": "Nie masz jeszcze zamówień — czas wybrać coś pysznego 🛒",
        "profile_empty": "Profil jest jeszcze pusty. Złóż pierwsze zamówienie, a pojawi się tu historia 🛒",
        ...
        "promo_applied_note": "🎟 Kod <b>{code}</b> zastosowany — rabat {percent}% jest już wliczony w kwotę.",
        "payment_confirmed": (
    ...
    "en": {
        "welcome": (
            ...
            "👇 <b>Menu at the bottom:</b>\n"
            "🛒 <b>Open shop</b> — catalogue and cart\n"
            "👤 <b>Profile</b> — your stats and saved details\n"
            "🧾 <b>My orders</b> — history and statuses\n"
            "❓ <b>How to order</b> — these instructions\n"
            "💬 <b>Manager</b> — get in touch\n\n"
        ...
        "menu_orders_btn": "🧾 My orders",
        "menu_help_btn": "❓ How to order",
        "menu_manager_btn": "💬 Manager",
        "manager_contact": (
            "💬 <b>Contact the manager</b>\n\n"
            "Any questions — message: @hollymollydeal\n\n"
            "🕐 Open: Mon-Fri 6:00-23:00 · Sat-Sun 10:00-22:00"
        ),
        ...
        "profile_title": "👤 <b>Profile: {name}</b>",
        "profile_stats": "🛒 Orders: <b>{count}</b> · total <b>{total} zł</b>",
        "profile_since": "📅 With us since {date}",
        "profile_delivery_title": "<b>Saved delivery details:</b>",
        "profile_orders_title": "<b>Recent orders:</b>",
        "profile_no_orders": "No orders yet — time to pick something tasty 🛒",
        "profile_empty": "Your profile is still empty. Place your first order and the history will appear here 🛒",
        ...
        "promo_applied_note": "🎟 Promo code <b>{code}</b> applied — {percent}% discount is already included.",
        "payment_confirmed": (
...
# Кеш активних промокодів. Оновлюється при старті, після зміни кодів
# командою /promo, і раз на годину. Потрібен, щоб будувати адресу магазину
# синхронно, без звернення до бази при кожному натисканні кнопки.
_promo_cache: list = []


async def refresh_promo_cache():
    """Перечитує активні промокоди з бази у кеш."""
    global _promo_cache
    try:
        promos = await db.a_get_active_promos()
        fresh = []
        for p in promos or []:
            ...
            if not code or percent <= 0:
                continue
            # Пропускаємо коди, які вичерпали ліміт використань
            max_uses = p.get("max_uses")
            if max_uses and (p.get("used_count") or 0) >= max_uses:
                continue
            fresh.append((code, percent))
        _promo_cache = fresh
        logger.info(f"Промокоди оновлено: {len(fresh)} активних")
    except Exception as e:
        logger.warning(f"Не вдалося оновити промокоди: {e}")


async def promo_cache_watchdog():
    """Раз на годину освіжає список промокодів."""
    while True:
        await asyncio.sleep(3600)
        await refresh_promo_cache()


def build_webapp_url() -> str:
    """
    Адреса магазину з переліком активних промокодів.
    Формат: ?promos=CODE1:10,CODE2:15
    Завдяки цьому сайт завжди знає актуальні коди з бази.
    """
    if not _promo_cache:
        return WEBAPP_URL
    from urllib.parse import quote
    promos = ",".join(f"{code}:{percent}" for code, percent in _promo_cache)
    sep = "&" if "?" in WEBAPP_URL else "?"
    return f"{WEBAPP_URL}{sep}promos={quote(promos, safe=':,')}"


ADMIN_PANEL_BUTTON = "⚙️ Адмінка"


def is_admin_id(user_id) -> bool:
    """Чи цей користувач — менеджер."""
    if user_id is None:
        return False
    try:
...
def open_shop_keyboard(lang: str, user_id: int = None) -> ReplyKeyboardMarkup:
    """
    Головне меню клієнта.

    ВАЖЛИВО: кнопка магазину має бути саме KeyboardButton із web_app —
    лише з такої кнопки Telegram дозволяє Mini App надсилати замовлення
    боту через sendData.
    """
    rows = [
        [KeyboardButton(text=t(lang, "open_shop_button"), web_app=WebAppInfo(url=build_webapp_url()))],
        [
            KeyboardButton(text=t(lang, "menu_profile_btn")),
            KeyboardButton(text=t(lang, "menu_orders_btn")),
        ],
        [
            KeyboardButton(text=t(lang, "menu_help_btn")),
            KeyboardButton(text=t(lang, "menu_manager_btn")),
        ],
    ]
    # Менеджеру додаємо окрему кнопку панелі керування.
...
def button_matches(text: str, key: str) -> bool:
    """Чи збігається натиснута кнопка з певним пунктом меню (будь-якою мовою)."""
    if not text:
        return False
    return text.strip() in {TEXTS[l].get(key, "\x00") for l in TEXTS}
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    # Привітання надсилаємо ПЕРШИМ — щоб клієнт побачив меню одразу,
    # незалежно від того, чи доступна база даних.
    await message.answer(
        t(lang, "welcome"),
        parse_mode="HTML",
        reply_markup=open_shop_keyboard(lang, message.from_user.id),
    )

    # І лише потім запам'ятовуємо клієнта в базі (для розсилок і статистики).
    # Якщо база недоступна — клієнт цього навіть не помітить.
    try:
        await db.a_upsert_client(
        ...
        logger.warning(f"Не вдалося зберегти клієнта {message.from_user.id}: {e}")
...
async def process_webapp_data(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(t(lang, "invalid_data"), reply_markup=open_shop_keyboard(lang, message.from_user.id))
        return
    ...
    # Промокод, який клієнт застосував у кошику. Перевіряємо його ще раз
    # за актуальним списком — щоб знижку не можна було підробити.
    promo_code = (payload.get("promo") or "").strip().upper() or None
    promo_percent = 0
    if promo_code:
        valid = dict(_promo_cache)
        if promo_code in valid:
            promo_percent = valid[promo_code]
        else:
            logger.warning(f"Клієнт надіслав недійсний промокод: {promo_code}")
            promo_code = None
    ...
    # Зберігаємо замовлення в базі (статус pending — очікує оплати).
    # Якщо база недоступна — замовлення все одно дійде до менеджера.
    await db.a_create_order(
        order_no=order_no,
        chat_id=message.from_user.id,
        lang=lang,
        customer_name=name,
    ...
    # Рахуємо використання коду, щоб працювали ліміти
    if promo_code:
        await db.a_bump_promo_usage(promo_code)
    await db.a_upsert_client(
        chat_id=message.from_user.id,
        username=message.from_user.username,
        first_name=message.from_user.first_name,
    ...
    # Запам'ятовуємо дані доставки — наступного разу клієнт побачить
    # їх у /profile і не вписуватиме заново.
    await db.a_save_delivery_details(message.from_user.id, name, phone, point)
    ...
    if promo_code and promo_percent:
        order_text += "\n\n" + t(lang, "promo_applied_note", code=promo_code, percent=promo_percent)
...
async def cancel_order_execute(callback: CallbackQuery, state: FSMContext):
    ...
    await db.a_set_order_status(order_no, "cancelled")
    ...
    await callback.message.answer(
        ...
        reply_markup=open_shop_keyboard(lang, callback.from_user.id),
    )
...
async def payment_proof_photo(message: Message, state: FSMContext):
    ...
    await message.answer(t(lang, "final_photo"), reply_markup=open_shop_keyboard(lang, message.from_user.id))
    await state.clear()
...
async def finalize_order(message: Message, state: FSMContext, lang: str, proof_note: str = "", client_id: int = None, client_username: str = None):
    ...
    await message.answer(t(lang, "final_button"), reply_markup=open_shop_keyboard(lang, client_id or message.chat.id))
    await state.clear()
...
async def autocancel_unpaid_order(order_no: str, client_id: int, name: str, phone: str, username: str = None):
    ...
    try:
        await bot.send_message(
            ...
            reply_markup=open_shop_keyboard(lang, client_id),
        )
    except Exception as e:
...
async def admin_confirm_payment(callback: CallbackQuery):
    ...
    await db.a_set_order_status(order_no, "paid")
    lang = await get_client_lang(client_id)
    try:
        await bot.send_message(
            chat_id=client_id,
...
async def admin_send_tracking(message: Message, state: FSMContext):
    ...
    if tracking == ADMIN_PANEL_BUTTON:
        await state.clear()
        await message.answer(
            "⚙️ <b>Панель керування</b>\n\nОберіть дію:",
            parse_mode="HTML",
    ...
    await db.a_set_order_status(order_no, "shipped", tracking_no=tracking)
...
# ---------------------------------------------------------------------------
# АДМІН-КОМАНДИ (доступні лише менеджеру)
# ---------------------------------------------------------------------------

def is_admin(message: Message) -> bool:
    """Перевіряє, що команду надіслав саме менеджер."""
    try:
...
async def cmd_export(message: Message):
    """Пропонує обрати, який звіт вивантажити у PDF."""
    if not is_admin(message):
        return
    if not await db.a_is_enabled():
        await message.answer("⚠️ База даних не підключена — експорт недоступний.")
        return

    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📄 Замовлення за 30 днів", callback_data="exp:orders30")],
        [InlineKeyboardButton(text="📄 Замовлення за 7 днів", callback_data="exp:orders7")],
        [InlineKeyboardButton(text="📄 Усі замовлення", callback_data="exp:ordersall")],
        [InlineKeyboardButton(text="💰 Тільки оплачені", callback_data="exp:paid")],
        [InlineKeyboardButton(text="👥 Клієнти", callback_data="exp:clients")],
    ])
    await message.answer("📤 <b>Що вивантажити?</b>", parse_mode="HTML", reply_markup=kb)


@router.callback_query(F.data.startswith("exp:"))
async def export_generate(callback: CallbackQuery):
    """Формує PDF і надсилає його менеджеру."""
    if str(callback.from_user.id) != str(ADMIN_CHAT_ID):
        await callback.answer()
        return

    kind = callback.data.split(":", 1)[1]
    await callback.answer("Формую звіт...")
    status_msg = await callback.message.answer("⏳ Формую PDF, це займе кілька секунд...")

    try:
        if kind == "clients":
            rows = await db.a_get_clients_for_export()
            if not rows:
                await status_msg.edit_text("У базі поки немає клієнтів.")
                return
            pdf = export_pdf.build_clients_pdf(rows)
            filename = f"holyliquid-clients-{datetime.now().strftime('%Y%m%d')}.pdf"
        else:
            params = {
                "orders30": (30, None, "Замовлення", "Останні 30 днів"),
                "orders7": (7, None, "Замовлення", "Останні 7 днів"),
                "ordersall": (None, None, "Замовлення", "За весь час"),
                "paid": (None, "paid", "Оплачені замовлення", "За весь час"),
            }.get(kind)

            if not params:
                await status_msg.edit_text("Невідомий тип звіту.")
                return

            days, status, title, period = params
            rows = await db.a_get_orders_for_export(days=days, status=status)
            if not rows:
                await status_msg.edit_text("За вибраний період замовлень немає.")
                return
            pdf = export_pdf.build_orders_pdf(rows, title=title, period=period)
            filename = f"holyliquid-orders-{datetime.now().strftime('%Y%m%d')}.pdf"

        if not pdf:
            await status_msg.edit_text(
                "❌ Не вдалося сформувати PDF.\n"
                "Найімовірніше, не вдалось завантажити шрифт із кирилицею. "
        ...
        await bot.send_document(
            ...
            caption=f"📄 Готово · записів: {len(rows)}",
        )
        try:
        ...
        logger.error(f"Помилка експорту ({kind}): {e}")
        try:
            await status_msg.edit_text(f"❌ Помилка при формуванні звіту: {e}")
        except Exception:
            pass
...
async def cmd_stats(message: Message):
    """Зведена статистика магазину."""
    if not is_admin(message):
        return
    if not await db.a_is_enabled():
        await message.answer("⚠️ База даних не підключена — статистика недоступна.")
        return

    s = await db.a_get_stats()
    if not s:
        await message.answer("Не вдалося отримати статистику. Перевірте логи.")
        return

    await message.answer(
        "📊 <b>Статистика HOLLY LIQUID</b>\n\n"
        f"👥 Клієнтів усього: <b>{s.get('clients_total', 0)}</b>\n"
        f"✅ Активних (не заблокували): <b>{s.get('clients_active', 0)}</b>\n\n"
        f"🕐 Очікують оплати: <b>{s.get('orders_pending', 0)}</b>\n"
        f"💰 Оплачених: <b>{s.get('orders_paid', 0)}</b>\n"
        f"📦 Відправлених: <b>{s.get('orders_shipped', 0)}</b>\n"
        f"❌ Скасованих: <b>{s.get('orders_cancelled', 0)}</b>\n\n"
        f"💵 Виторг (оплачені + відправлені): <b>{s.get('revenue', 0):.2f} zł</b>",
        parse_mode="HTML",
    )
...
async def cmd_promo(message: Message):
    ...
    Керування промокодами:
      /promo               — показати активні
      /promo add CODE 15   — додати код зі знижкою 15%
      /promo off CODE      — вимкнути код
    """
    if not is_admin(message):
        return
    if not await db.a_is_enabled():
        await message.answer("⚠️ База даних не підключена — промокоди недоступні.")
        return
    ...
    if len(parts) == 1:
        promos = await db.a_get_active_promos()
        if not promos:
            await message.answer("Активних промокодів немає.\n\nДодати: <code>/promo add CODE10 10</code>", parse_mode="HTML")
            return
        lines = []
        for p in promos:
            used = p.get("used_count", 0)
            limit = p.get("max_uses")
            limit_txt = f" ({used}/{limit})" if limit else f" (використано {used})"
            lines.append(f"• <code>{p['code']}</code> — {p['percent']}%{limit_txt}")
        await message.answer("🎟 <b>Активні промокоди</b>\n\n" + "\n".join(lines), parse_mode="HTML")
        return
    ...
    if action == "add" and len(parts) >= 4:
        ...
        try:
            ...
            await message.answer("Відсоток має бути числом. Приклад: <code>/promo add SUMMER 15</code>", parse_mode="HTML")
            return
        max_uses = None
        if len(parts) >= 5:
            try:
                ...
                pass
        if await db.a_add_promo(code, percent, max_uses):
            await refresh_promo_cache()
            limit_txt = f", ліміт {max_uses} використань" if max_uses else ""
            await message.answer(
                f"✅ Промокод <code>{code}</code> додано — знижка {percent}%{limit_txt}\n\n"
                f"Він одразу доступний клієнтам у кошику.",
                parse_mode="HTML",
            )
        else:
            await message.answer("Не вдалося додати промокод. Перевірте логи.")
        return

    if action == "off" and len(parts) >= 3:
        code = parts[2].upper()
        if await db.a_disable_promo(code):
            await refresh_promo_cache()
            await message.answer(f"🚫 Промокод <code>{code}</code> вимкнено", parse_mode="HTML")
        else:
            await message.answer("Не вдалося вимкнути промокод. Перевірте логи.")
        return

    await message.answer(
        "Команди для промокодів:\n\n"
        "<code>/promo</code> — список активних\n"
        "<code>/promo add CODE 15</code> — додати (15% знижки)\n"
        "<code>/promo add CODE 15 100</code> — з лімітом 100 використань\n"
        "<code>/promo off CODE</code> — вимкнути",
        parse_mode="HTML",
    )
...
async def cmd_broadcast_start(message: Message, state: FSMContext):
    """Починає створення розсилки."""
    if not is_admin(message):
        return
    if not await db.a_is_enabled():
        await message.answer("⚠️ База даних не підключена — розсилка недоступна.")
        return

    ids = await db.a_get_all_client_ids()
    if not ids:
        await message.answer("У базі поки немає клієнтів для розсилки.")
        return

    await state.set_state(BroadcastForm.waiting_text)
    await message.answer(
        f"📢 <b>Нова розсилка</b>\n\n"
        f"Отримувачів: <b>{len(ids)}</b>\n\n"
        f"Надішліть текст повідомлення наступним повідомленням.\n"
        f"Можна використовувати <b>жирний</b>, <i>курсив</i> та емодзі.\n\n"
        f"Для скасування напишіть <code>скасувати</code>",
        parse_mode="HTML",
    )


@router.message(BroadcastForm.waiting_text)
async def cmd_broadcast_text(message: Message, state: FSMContext):
    """Отримує текст розсилки і просить підтвердження."""
    if not is_admin(message):
        return
    ...
    # Натиснув кнопку панелі — це не текст розсилки
    if raw == ADMIN_PANEL_BUTTON:
        await state.clear()
        await message.answer(
            "⚙️ <b>Панель керування</b>\n\nОберіть дію:",
            parse_mode="HTML",
    ...
    if not text.strip():
        await message.answer("Порожнє повідомлення. Надішліть текст розсилки.")
        return
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text=f"📤 Надіслати ({len(ids)})", callback_data="bc_send"),
        InlineKeyboardButton(text="❌ Скасувати", callback_data="bc_cancel"),
    ]])

    await message.answer("👀 <b>Так виглядатиме повідомлення:</b>", parse_mode="HTML")
    await message.answer(text, parse_mode="HTML")
    await message.answer("Надіслати цю розсилку?", reply_markup=kb)
...
async def broadcast_send(callback: CallbackQuery, state: FSMContext):
    """Виконує розсилку з обмеженням швидкості, щоб Telegram не заблокував."""
    data = await state.get_data()
    ...
    if not text:
        await callback.message.answer("Текст розсилки втрачено. Спробуйте ще раз через /broadcast")
        return

    ids = await db.a_get_all_client_ids()
    status_msg = await callback.message.answer(f"📤 Розсилка почалась... 0/{len(ids)}")
    ...
    for i, chat_id in enumerate(ids, 1):
        try:
            ...
            failed += 1
            # Якщо клієнт заблокував бота — позначаємо, щоб не слати надалі
            if "blocked" in str(e).lower() or "chat not found" in str(e).lower():
                await db.a_mark_client_blocked(chat_id)

        # Telegram дозволяє ~30 повідомлень/сек; тримаємо запас
        await asyncio.sleep(0.05)

        if i % 25 == 0:
            try:
                await status_msg.edit_text(f"📤 Розсилка триває... {i}/{len(ids)}")
            except Exception:
                pass
    ...
    try:
        ...
        await callback.message.answer(f"✅ Розсилку завершено. Доставлено: {sent}, не вдалося: {failed}")


@router.message(Command("profile"))
async def cmd_profile(message: Message, state: FSMContext):
    """Особистий профіль клієнта: статистика, збережені дані, останні замовлення."""
    if not await db.a_is_enabled():
        await message.answer("Профіль тимчасово недоступний. Спробуй пізніше 🙏")
        return
    ...
    chat_id = message.from_user.id
    profile = await db.a_get_client_profile(chat_id)
    orders = await db.a_get_client_orders(chat_id, limit=5)

    if not profile:
        await message.answer(t(lang, "profile_empty"), reply_markup=open_shop_keyboard(lang, message.from_user.id))
        return

    name = profile.get("first_name") or message.from_user.first_name or "—"
    orders_count = profile.get("orders_count") or 0
    total_spent = float(profile.get("total_spent") or 0)
    since = (profile.get("first_seen") or "")[:10]

    lines = [t(lang, "profile_title", name=name), ""]
    lines.append(t(lang, "profile_stats", count=orders_count, total=f"{total_spent:.2f}"))
    if since:
        lines.append(t(lang, "profile_since", date=since))

    # Збережені дані доставки
    saved_name = profile.get("saved_name")
    saved_phone = profile.get("saved_phone")
    saved_point = profile.get("saved_point")
    if saved_name or saved_phone or saved_point:
        lines.append("")
        lines.append(t(lang, "profile_delivery_title"))
        if saved_name:
            lines.append(f"👤 {saved_name}")
        if saved_phone:
            lines.append(f"📞 {saved_phone}")
        if saved_point:
            lines.append(f"📦 {saved_point}")
    ...
    if orders:
        status_labels = {
            ...
            "shipped": t(lang, "status_shipped"),
            "cancelled": t(lang, "status_cancelled"),
        }
        lines.append("")
        lines.append(t(lang, "profile_orders_title"))
        for o in orders:
            created = (o.get("created_at") or "")[:10]
            st = status_labels.get(o.get("status"), o.get("status", "—"))
            row = f"<b>{o['order_no']}</b> · {o.get('total', 0)} zł · {st} · {created}"
            if o.get("tracking_no"):
                row += f"\n   📮 <code>{o['tracking_no']}</code>"
            lines.append(row)
    else:
        lines.append("")
        lines.append(t(lang, "profile_no_orders"))
...
async def cmd_my_orders(message: Message):
    """Історія замовлень клієнта — доступна всім."""
    if not await db.a_is_enabled():
        return

    orders = await db.a_get_client_orders(message.from_user.id, limit=10)
    if not orders:
    ...
    for o in orders:
        created = (o.get("created_at") or "")[:10]
        st = status_labels.get(o.get("status"), o.get("status", "—"))
        line = f"<b>{o['order_no']}</b> — {o.get('total', 0)} zł\n{st} · {created}"
        if o.get("tracking_no"):
            line += f"\n📮 <code>{o['tracking_no']}</code>"
        lines.append(line)
...
# Реагують на текст кнопок будь-якою з трьох мов.
# ---------------------------------------------------------------------------

@router.message(F.text.func(lambda txt: button_matches(txt, "menu_profile_btn")))
async def menu_profile(message: Message, state: FSMContext):
    await cmd_profile(message, state)


@router.message(F.text.func(lambda txt: button_matches(txt, "menu_orders_btn")))
async def menu_orders(message: Message, state: FSMContext):
    await cmd_my_orders(message)


@router.message(F.text.func(lambda txt: button_matches(txt, "menu_help_btn")))
async def menu_help(message: Message, state: FSMContext):
    await cmd_help(message, state)


# ---------------------------------------------------------------------------
# АДМІН-ПАНЕЛЬ (кнопки замість команд)
# ---------------------------------------------------------------------------

def admin_panel_keyboard() -> InlineKeyboardMarkup:
    """Головне меню панелі керування."""
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📊 Статистика", callback_data="ap:stats")],
        [InlineKeyboardButton(text="🎟 Промокоди", callback_data="ap:promos")],
        [InlineKeyboardButton(text="📢 Розсилка", callback_data="ap:broadcast")],
        [InlineKeyboardButton(text="📤 Вивантажити PDF", callback_data="ap:export")],
    ])


@router.message(F.text == ADMIN_PANEL_BUTTON)
async def open_admin_panel(message: Message):
    """Відкриває панель керування (лише для менеджера)."""
...
async def admin_panel_back(callback: CallbackQuery, state: FSMContext):
    """Повернення до головного меню панелі."""
...
async def admin_panel_stats(callback: CallbackQuery):
    """Показує статистику всередині панелі."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    await callback.answer()
    ...
    if not await db.a_is_enabled():
        await callback.message.edit_text(
            "⚠️ База даних не підключена — статистика недоступна.",
    ...
    text = (
        "📊 <b>Статистика HOLLY LIQUID</b>\n\n"
        f"👥 Клієнтів усього: <b>{s.get('clients_total', 0)}</b>\n"
        f"✅ Активних: <b>{s.get('clients_active', 0)}</b>\n\n"
        f"🕐 Очікують оплати: <b>{s.get('orders_pending', 0)}</b>\n"
        f"💰 Оплачених: <b>{s.get('orders_paid', 0)}</b>\n"
        f"📦 Відправлених: <b>{s.get('orders_shipped', 0)}</b>\n"
        f"❌ Скасованих: <b>{s.get('orders_cancelled', 0)}</b>\n\n"
        f"💵 Виторг: <b>{s.get('revenue', 0):.2f} zł</b>"
    ) if s else "Не вдалося отримати статистику."

    await callback.message.edit_text(
        text, parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🔄 Оновити", callback_data="ap:stats")],
            [InlineKeyboardButton(text="◀️ Назад", callback_data="ap:back")],
        ]),
    )
...
async def admin_panel_export(callback: CallbackQuery):
    """Меню вивантаження звітів."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    await callback.answer()
...
async def admin_panel_broadcast(callback: CallbackQuery, state: FSMContext):
    """Запускає створення розсилки з панелі."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    await callback.answer()
    ...
    if not await db.a_is_enabled():
        await callback.message.edit_text(
            "⚠️ База даних не підключена — розсилка недоступна.",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="◀️ Назад", callback_data="ap:back")]
            ]),
        )
    ...
    if not ids:
        await callback.message.edit_text(
            "У базі поки немає клієнтів для розсилки.",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="◀️ Назад", callback_data="ap:back")]
            ]),
        )
    ...
    await callback.message.edit_text(
        ...
        parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="◀️ Скасувати", callback_data="ap:back")]
        ]),
    )


class PromoForm(StatesGroup):
    """Покрокове створення промокоду через кнопки."""
    waiting_code = State()
    waiting_percent = State()


@router.callback_query(F.data == "ap:promos")
async def admin_panel_promos(callback: CallbackQuery, state: FSMContext):
    """Список активних промокодів із кнопками керування."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    await state.clear()
    ...
    if not await db.a_is_enabled():
        await callback.message.edit_text(
            "⚠️ База даних не підключена — промокоди недоступні.",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="◀️ Назад", callback_data="ap:back")]
            ]),
        )
    ...
    rows = [[InlineKeyboardButton(text="➕ Створити промокод", callback_data="ap:promo_new")]]
    if promos:
        lines = ["🎟 <b>Активні промокоди</b>\n"]
        for p in promos:
            used = p.get("used_count", 0)
            limit = p.get("max_uses")
            limit_txt = f" · {used}/{limit}" if limit else f" · використано {used}"
            lines.append(f"• <code>{p['code']}</code> — {p['percent']}%{limit_txt}")
            rows.append([InlineKeyboardButton(
                text=f"🚫 Вимкнути {p['code']}",
                callback_data=f"ap:promo_off:{p['code']}",
            )])
        text = "\n".join(lines)
    else:
        text = "🎟 <b>Промокоди</b>\n\nАктивних промокодів немає."

    rows.append([InlineKeyboardButton(text="◀️ Назад", callback_data="ap:back")])
    await callback.message.edit_text(text, parse_mode="HTML",
                                     reply_markup=InlineKeyboardMarkup(inline_keyboard=rows))


@router.callback_query(F.data.startswith("ap:promo_off:"))
async def admin_promo_disable(callback: CallbackQuery, state: FSMContext):
    """Вимикає обраний промокод."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    ...
    if await db.a_disable_promo(code):
        await refresh_promo_cache()
        await callback.answer(f"Промокод {code} вимкнено")
    else:
        await callback.answer("Не вдалося вимкнути", show_alert=True)
    await admin_panel_promos(callback, state)


@router.callback_query(F.data == "ap:promo_new")
async def admin_promo_new(callback: CallbackQuery, state: FSMContext):
    """Крок 1 — просимо ввести назву промокоду."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return
    await callback.answer()
    ...
    await callback.message.edit_text(
        "➕ <b>Новий промокод</b>\n\n"
        "Крок 1 з 2 — надішліть назву коду одним повідомленням.\n"
        "Наприклад: <code>ОСІНЬ20</code> або <code>SUMMER15</code>",
        parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="◀️ Скасувати", callback_data="ap:back")]
        ]),
...
async def admin_promo_code_entered(message: Message, state: FSMContext):
    """Крок 2 — пропонуємо обрати відсоток кнопками."""
    if not is_admin_id(message.from_user.id):
        return
    ...
    if not code or len(code) > 32 or " " in code:
        await message.answer("Назва має бути одним словом до 32 символів. Спробуйте ще раз.")
        return

    await state.update_data(new_promo_code=code)
    await state.set_state(PromoForm.waiting_percent)

    percents = [5, 10, 15, 20, 25, 30, 40, 50]
    rows, row = [], []
    for p in percents:
        row.append(InlineKeyboardButton(text=f"{p}%", callback_data=f"ap:promo_pct:{p}"))
        if len(row) == 4:
            rows.append(row); row = []
    if row:
        rows.append(row)
    rows.append([InlineKeyboardButton(text="◀️ Скасувати", callback_data="ap:back")])

    await message.answer(
        f"Код: <code>{code}</code>\n\n"
        f"Крок 2 з 2 — оберіть розмір знижки:",
        parse_mode="HTML",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=rows),
    )


@router.callback_query(F.data.startswith("ap:promo_pct:"))
async def admin_promo_percent_chosen(callback: CallbackQuery, state: FSMContext):
    """Створює промокод із обраним відсотком."""
    if not is_admin_id(callback.from_user.id):
        await callback.answer()
        return

    try:
        percent = int(callback.data.split(":", 2)[2])
    except ValueError:
        await callback.answer("Некоректний відсоток", show_alert=True)
        return
    ...
    if not code:
        await callback.answer("Дані втрачено, почніть спочатку", show_alert=True)
        return

    if await db.a_add_promo(code, percent):
        await refresh_promo_cache()
        await callback.answer(f"Промокод {code} створено")
        await callback.message.edit_text(
            f"✅ <b>Промокод створено</b>\n\n"
            f"Код: <code>{code}</code>\n"
            f"Знижка: <b>{percent}%</b>\n\n"
            f"Клієнти вже можуть вводити його в кошику.",
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="🎟 До промокодів", callback_data="ap:promos")],
                [InlineKeyboardButton(text="◀️ У меню", callback_data="ap:back")],
            ]),
        )
    else:
        await callback.answer("Не вдалося створити промокод", show_alert=True)


@router.message(F.text.func(lambda txt: button_matches(txt, "menu_manager_btn")))
async def menu_manager(message: Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text="💬 @hollymollydeal", url="https://t.me/hollymollydeal")
    ]])
    await message.answer(t(lang, "manager_contact"), parse_mode="HTML", reply_markup=kb)
...
async def setup_bot_commands():
    """
    Налаштовує меню команд (те, що показується при вводі "/").

    Telegram дозволяє задавати різні набори команд для різних областей:
      - BotCommandScopeDefault  — бачать УСІ клієнти
      - BotCommandScopeChat     — бачить лише конкретний чат (менеджер)

    Завдяки цьому клієнти НЕ побачать адмін-команд.
    """
    # 1. Команди для всіх клієнтів
    client_commands = [
        BotCommand(command="start", description="🛒 Відкрити магазин"),
        BotCommand(command="profile", description="👤 Мій профіль"),
        BotCommand(command="myorders", description="🧾 Мої замовлення"),
        BotCommand(command="help", description="❓ Як зробити замовлення"),
    ]
    try:
        await bot.set_my_commands(client_commands, scope=BotCommandScopeDefault())
        logger.info("Команди для клієнтів встановлено")
    except Exception as e:
        logger.error(f"Не вдалося встановити команди для клієнтів: {e}")

    # 2. Розширений набір — лише для менеджера
    admin_commands = client_commands + [
        BotCommand(command="stats", description="📊 Статистика магазину"),
        BotCommand(command="broadcast", description="📢 Розсилка клієнтам"),
        BotCommand(command="promo", description="🎟 Промокоди"),
        BotCommand(command="export", description="📤 Вивантажити PDF-звіт"),
    ]
    try:
        ...
        logger.info("Команди для менеджера встановлено")
    except Exception as e:
        logger.error(f"Не вдалося встановити команди для менеджера: {e}")


async def on_startup(app: web.Application):
    """Реєструє webhook у Telegram при запуску сервісу."""
    # Меню команд налаштовуємо завжди — навіть якщо webhook не задано.
    await setup_bot_commands()

    # Прогріваємо підключення до бази заздалегідь. Інакше найперший
    # клієнт чекав би кілька секунд, поки завантажиться бібліотека
    # Supabase, і Telegram міг би не дочекатись відповіді.
    try:
        await db.warm_up()
        logger.info("Підключення до бази прогріто")
    except Exception as e:
        logger.warning(f"Не вдалося прогріти базу: {e}")

    # Читаємо активні промокоди — вони підставляються в адресу магазину.
    await refresh_promo_cache()
    asyncio.create_task(promo_cache_watchdog())
